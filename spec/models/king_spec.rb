...
RSpec.describe King, type: :model do
  ...
  describe 'king making a valid_move?' do
    context 'valid move within 1 square' do
      it 'be a valid move' do
        ...
        king = King.create(x_position: 3, y_position: 5, game: game, color: 'WHITE')
  ...
  # CASTLE TESTS - CASTLING TESTS & METHODS NEED WORK
  ...
  #     game = create(:game)
  #     game.pieces.delete_all
  #     king = King.create(x_position: 4, y_position: 0, state: 'unmoved', game: game, color: 'WHITE')
  #     rook = Rook.create(x_position: 7, y_position: 0, state: 'unmoved', game: game, color: 'WHITE')
